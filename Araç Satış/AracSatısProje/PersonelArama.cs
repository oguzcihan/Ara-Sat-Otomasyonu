...
namespace AracSatısProje
{
    public partial class Personel_Arama : Form
    {
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = "Ad Like '" + textBox2.Text + "%'";
        ...
        private void Personel_Arama_Load(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("SELECT * From personelKayit ", baglanti);
        ...
        {
            secilenpersonel = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            
            Form sonuc = new personelKayit();
            sonuc.Show();
            this.Hide();
                ...
                while (iRow <= dataGridView1.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("Rapor", new Font(dataGridView1.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                    e.Graphics.MeasureString("Rapor", new Font(dataGridView1.Font,
                            ...
                            e.Graphics.DrawString(strDate, new Font(dataGridView1.Font, FontStyle.Bold),
                                    ...
                                    e.Graphics.MeasureString("Rapor", new Font(new Font(dataGridView1.Font,
